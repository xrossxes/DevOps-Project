...
public class CreateMovieServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String p = request.getParameter("director");
		String e = request.getParameter("releaseDate");
		String c = request.getParameter("genre");
		String a = request.getParameter("plot");
		
		//Step 3: attempt connection to database using JDBC, you can change the username and password accordingly using the phpMyAdmin > User Account dashboard
		try {
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection(
				"jdbc:mysql://localhost:3306/moviedetails", "root", "password");
